<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <!--
      <div class="form-group required">
        <label class="control-label" for="input-payment-telephone"><?php echo "Mobile"; //$entry_telephone; ?></label>
    ...
    <fieldset id="address">
      ...
      <div class="form-group required">
       <!-- <label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>-->
        <input type="hidden" name="postcode" value="NIL" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
      </div>
      <div class="form-group required">
       <!-- <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?></label>-->
        <select name="country_id" id="input-payment-country" class="form-control" style="display:none">
          <option value="India" selected><?php echo "India"; // $text_select; ?></option>
