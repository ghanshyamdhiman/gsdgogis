<form class="form-horizontal">
  ...
  <div id="shipping-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> , <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['country']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> , <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>,  <?php echo $address['country']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    <div class="form-group required">
      ...
      <label class="col-sm-2 control-label" for="input-shipping-firstname"><?php echo "Name"; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-10">
        <input type="text" name="lastname" value="Ji" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
      </div>
    </div>
    ...
    <!--
      ...
      -->
      <div class="col-sm-10">
        <input type="hidden" name="company" value="My Company" placeholder="<?php echo $entry_company; ?>" id="input-shipping-company" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-shipping-address-1"><?php echo "Address"; ?></label>
      <div class="col-sm-10">
    ...
    <!--
      ...
      -->
      <div class="col-sm-10">
        <input type="hidden" name="address_2" value="NIL" placeholder="<?php echo $entry_address_2; ?>" id="input-shipping-address-2" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      ...
      <div class="col-sm-10">
        <input type="text" name="city" value="Nagpur" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
    <!--
      ...
      -->
      <div class="col-sm-10">
        <input type="hidden" name="postcode" value="<?php echo "440010"; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
    <!--
      ...
      -->
      <div class="col-sm-10">
        <select name="country_id" id="input-shipping-country" class="form-control" style="display:none">
          <option value="India" selected="selected"><?php echo "India"; ?></option>
    ...
    <!--
      ...
      -->
      <div class="col-sm-10">
        <select name="zone_id" id="input-shipping-zone" class="form-control" style="display:none">
        </select>
      </div>
    </div>
...
$('#collapse-shipping-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			html = '<option value="Maharashtra" selected="selected"><?php echo "Maharashtra";?></option>';
