<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
      ...
      <label class="col-sm-2 control-label" for="input-payment-firstname"><?php echo "Name"; // $entry_firstname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="firstname" value="" placeholder="<?php echo "Name"; // $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
      </div>
    </div>
    <!--
    <div class="form-group required">
    ...
    -->
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-payment-address-1"><?php echo "Address"; // $entry_address_1; ?></label>
      <div class="col-sm-10">
        <input type="text" name="address_1" value="" placeholder="<?php echo "Address"; // $entry_address_1; ?>" id="input-payment-address-1" class="form-control" />
      </div>
    </div>
    <!--
    <div class="form-group">
