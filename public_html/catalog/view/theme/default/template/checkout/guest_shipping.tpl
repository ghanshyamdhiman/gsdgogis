<form class="form-horizontal">
  ...
  <div class="form-group required">
   <!--
    ...
    -->
    <div class="col-sm-10">
      <input type="hidden" name="lastname" value="Ji" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
    </div>
  </div>
  ...
  <!--
    <label class="col-sm-2 control-label" for="input-shipping-company"><?php echo $entry_company; ?></label>
        <div class="col-sm-10">
         -->
      <input type="hidden" name="company" value="<?php echo "My Company"; //$company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-shipping-company" class="form-control" />
    </div>
  </div>
 
  <div class="form-group required">
    <label class="col-sm-2 control-label" for="input-shipping-address-1"><?php echo "Address"; //$entry_address_1; ?></label>
    <div class="col-sm-10">
  ...
  <!--
    ...
    -->
    <div class="col-sm-10">
      <input type="hidden" name="city" value="Nagpur" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="form-control" />
    </div>
  </div>
  <div class="form-group required">
  <!--
    ...
    -->
    <div class="col-sm-10">
      <input type="hidden" name="postcode" value="440010" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
    </div>
  </div>
  <div class="form-group required">
  <!--
