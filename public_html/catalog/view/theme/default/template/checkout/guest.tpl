  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-firstname"><?php echo "Name"; // $entry_firstname; ?></label>
        <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo "Name"; // $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
      </div>
       <div class="form-group required">
        <!--<label class="control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>-->
        <input type="hidden" name="lastname" value=" Ji" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      </div>
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="fax" value="faxno" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="company" value="My Company" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control" />
      </div>
     
      <div class="form-group required">
        <label class="control-label" for="input-payment-address-1"><?php echo "Address"; //$entry_address_1; ?></label>
     ...
     <div class="form-group required">
        <label class="control-label" for="input-payment-telephone"><?php echo "Mobile No";  // $entry_telephone; ?></label>
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="address_2" value="nil" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="form-control" />
      </div>
     
      <div class="form-group required">
        <!--<label class="control-label" for="input-payment-city"><?php echo $entry_city; ?></label>-->
        <input type="hidden" name="city" value="Nagpur" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group required">
        <!--<label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>-->
        <input type="hidden" name="postcode" value="440010" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
      </div>
    
      <div class="form-group required">
       <!-- <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?></label>-->
        <select name="country_id" id="input-payment-country" class="form-control" style="display:none">
          <option value="India" selected="selected"><?php echo "India"; // $text_select; ?></option>
      ...
      <div class="form-group required">
        ...
        <select name="zone_id" id="input-payment-zone" class="form-control" style="display:none">
...
$('#collapse-payment-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			html = '<option value="Maharashtra" selected="selected"><?php echo "Maharashtra"; //$text_select; ?></option>';
			...
			if (json['zone'] && json['zone'] != '') {
				...
				html += '<option value="Maharashtra" selected="selected"><?php echo $text_none; ?></option>';
			}
